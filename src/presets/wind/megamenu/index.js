  ...
  content: ({ props, context }) => ({
    class: [
      ...
      //  Colors
      {
        ...
        'text-surface-500 dark:text-white/70 bg-surface-200 dark:bg-stone-900/70':
          context.focused && !context.active,
        'text-surface-900 dark:text-surface-0/80 bg-surface-50 dark:bg-stone-900/70':
          context.focused && context.active,
        'text-surface-900 dark:text-surface-0/80 bg-surface-50 dark:bg-stone-900/70':
          !context.focused && context.active
      },
      ...
      // Hover States
      {
        ...
        'hover:bg-surface-100 dark:hover:bg-stone-900/40 text-surface-900 dark:text-surface-0/80':
          context.active
      },
