export default {
    ...
    column: {
        ...
        sort: ({ context }) => ({
            class: [context.sorted ? 'text-primary-500' : 'text-surface-700', context.sorted ? ' ' : ' ']
        }),
            ...
            box: ({ props }) => ({
                class: [
                    ...
                    // States
                    {
                        ...
                        'peer-hover:border-primary-600   peer-hover:bg-primary-600  ': !props.disabled && props.modelValue,
