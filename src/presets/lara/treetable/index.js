export default {
    ...
    headercell: ({ context, props }) => ({
        class: [
            ...
            // States
            { 'hover:bg-surface-100  ': (props.sortable === '' || props.sortable) && !context?.sorted },
    ...
    column: {
        ...
        sorticon: ({ context }) => ({
            class: ['ml-2 inline-block', context.sorted ? 'fill-primary-700  ' : 'fill-surface-700  ']
        }),
        sortbadge: {
            class: [
                // Flex & Alignment
            ...
            box: {
                class: [
                    ...
                    // States
                    {
                        ...
                        'peer-hover:bg-primary-700   peer-hover:border-primary-700  ': !props.disabled && context.checked,
